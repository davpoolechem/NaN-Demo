...
void nan_demo_a() {
  ...
  std::cout << "sqrt(complex(-1.0)) => " << sqrt_neg_one_complex << std::endl;
  std::cout << std::endl;
}
...
void nan_demo_b() { 
  ...
  std::cout << "isnan(sqrt(-1.0))? " << (isnan(sqrt_neg_one_nan) ? "True" : "False") << std::endl;
  std::cout << std::endl;
}
...
void nan_demo_c() { 
  ...
  std::cout << "sqrt(-1.0)^2.0 => " << (std::pow(sqrt_neg_one_nan, 2.0)) << std::endl;
